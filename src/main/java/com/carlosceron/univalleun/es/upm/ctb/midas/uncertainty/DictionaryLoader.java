...
public class DictionaryLoader {
	...
	public ArrayList<String>  loadDictionary() {
		 ...
		 //ClassPathResource resource =  new ClassPathResource("entries.txt");
		//Resource resource = resourceLoader.getResource("classpath:entries.txt");
		//InputStream input = resource.getInputStream();
		 //File file = new File(resource.getFile());
		File file = null;
		try {
			file = ResourceUtils.getFile("classpath:entries.txt");
		} catch (IOException e) {
			e.printStackTrace();
		}
		try {
